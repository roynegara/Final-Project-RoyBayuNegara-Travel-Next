    ...
    <form onSubmit={handleEditBanner}>
      <div className="form-edit-banner">
        ...
        <div>
          ...
          <input
            defaultValue={defaultTerms_condition}
          ...
          <input
            defaultValue={defaultPromo_discount_price}
            name="promoHargaDiskon"
            placeholder="Masukkan Promo Harga Diskon"
          />
          <input
            defaultValue={defaultMinimum_claim_price}
            name="klaimHargaMinimum"
            placeholder="Masukkan Klaim Harga Minimum"
          />
        </div>
        <div>
