...
const Register = () => {
  ...
  return (
    <div>
      ...
      <input type="password" name="passwordRepeat" value={passwordRepeat} onChange={handlePasswordRepeatChange} />
      {/* <input type="text" name="role" value={role} onChange={handleRoleChange} placeholder="role"/> */}
      <div>
