    ...
    <div>
      <div className="home-title">
        ...
        <div className="home-title-btn">
          <a className="home-title-btn-inner" href="/login">
            Login
          </a>
          <a className="home-title-btn-inner" href="/register">
            Register
          </a>
        </div>
      </div>
      <div className="home">
        ...
        <div className="promos-home-wrapper">
          <h1>
            ...
            Enjoy your trip with our promo
          </h1>
          ...
          <div className="see-more-promo">
            <Link className="see-more-promos-home" href="/promo">
              See All Promos &gt;{" "}
            </Link>
          </div>
        </div>
        ...
        <div className="categories-home-wrapper">
          <h1>
            ...
            Explore the world and enhance your trip
          </h1>
          ...
          <div className="see-more-promo">
            <Link className="see-more-promos-home" href="/category">
              See All Categorys &gt;{" "}
            </Link>
          </div>
        </div>
        ...
        <div className="activities-home-wrapper">
          <h1>
            ...
            Top destination for your travels
          </h1>
          ...
          <div className="see-more-promo">
            <Link className="see-more-promos-home" href="/activity">
